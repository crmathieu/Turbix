...
int mkdPutc(),mkdGetc(),mkdGetche(),mkdGetch();
extern long atol();
...
/*-----------------------------------------------------------------------------
 * mkdScanf - saisie formattee a partir de l'entree standard
 *-----------------------------------------------------------------------------
 */
BIBLIO mkdScanf(strfmt,args)
char *strfmt;
{

    _Scnf(strfmt, mkdGetch , mkdPutc, &args, stdin, stdout);
    return(ROK);
}

/*-----------------------------------------------------------------------------
 * mkdFscanf - saisie format‚e a partir du stream specifie ( device ou fichier )
 *-----------------------------------------------------------------------------
 */
BIBLIO mkdFscanf(fd, strfmt, args)
int fd;
char *strfmt;
{
    _Scnf(strfmt, mkdGetch, mkdPutc ,&args, fd, stdout);
    return(ROK);
}

/*-----------------------------------------------------------------------------
 * mkdSscanf - Saisie formatt‚e a pratir d'un buffer
 *-----------------------------------------------------------------------------
 */
BIBLIO mkdSscanf(str, strfmt, args)
char *str;
char *strfmt;
{

    _Scnf(strfmt, mkdGetch, mkdPutc ,&args, BADDEV, stdout, str);
    return(ROK);
}
